...
/**
 * Example Login Page implementation using the Selenium Automation Framework.
 * This demonstrates how to extend BasePage and create page objects.
 */
public class LoginPage extends BasePage {
    ...
    public DashboardPage login(String username, String password) {
        ...
        // Return next page object (assuming successful login)
    ...
    public DashboardPage loginAndVerifySuccess(String username, String password) {
